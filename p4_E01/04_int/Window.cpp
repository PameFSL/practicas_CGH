#include "Window.h"
//incluimos libreria glm para utilizar los vectores
//glm
#include<glm.hpp>
#include<gtc\matrix_transform.hpp>
#include<gtc\type_ptr.hpp>

glm::vec3 pos_camara = glm::vec3(0.0f, 0.0f, 6.0f);		//vector posicion
glm::vec3 camara_front = glm::vec3(0.0f, 0.0f, -6.0f);	//vector dirección 
glm::vec3 camara_up = glm::vec3(0.0f, 1.0f, 0.0f);		//vector vertical
float az = 0.0f; 
float angleX = 0.0f;
float angleY = 0.0f;
...
float Window::anguloX() {
	return angleX;
}
float Window::anguloY() {
	return angleY;
}
