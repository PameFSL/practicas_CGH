...
void CrearTriangulo()
{
	...
	GLfloat vertices[] = {//Datos de posiciones, se le pueden añadir tambien el color que entraria como in a fragment shader, se agregan en sentido antihorario
		...
		-0.6f,-0.3f, 0.0f,//inf derecha
		-0.8f,-0.4f,0.0f

		- 0.6f,-0.3f,0.0,//inf izq
		-0.8f,-0.3f, 0.0f,//inf derecha
		-0.8f,-0.4f,0.0f

		- 0.8,-0.4f,0.0,//inf izq
		-0.8f,0.5f, 0.0f,//inf derecha
		-0.9f,0.5f,0.0f
...
int main()
{
 ...
 //Crear tríangulo
	...
	while (!glfwWindowShouldClose(mainWindow))
	{
		...
		glDrawArrays(GL_TRIANGLES,0,36);//este comando es el que dibujará el triangulo en la ventana, desde la localidad 0 y cada 3 son los vertices
