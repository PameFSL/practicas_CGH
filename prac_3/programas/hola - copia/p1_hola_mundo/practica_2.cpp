...
//********
//agregamos una variable llamada color_letr, la cual recibirá el color
...
void CrearTriangulo()
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(color_letra), color_letra, GL_STATIC_DRAW); //pasarle los datos al VBO asignando tamano, los datos y en este caso es estático pues no se modificarán los valores
	//atributos de posicion
...
int main()
{
	...
	//CREAR VENTANA
	GLFWwindow *mainWindow = glfwCreateWindow(WIDTH, HEIGHT, "Práctica 2", NULL, NULL);
